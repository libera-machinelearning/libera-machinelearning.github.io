# Getting started
Proficiency in [Python 3](https://www.python.org/) and [R](https://www.r-project.org/) is strongly recommended for practicing modern machine learning. Only after learning these, here are some basic starter resources for applied machine learning:
