# Getting started
Proficiency in both [Python 3](https://www.python.org/) and [R](https://www.r-project.org/) is strongly recommended for practicing modern machine learning. While Python is used heavily for machine learning including deep learning, R is popular among data scientists and statisticians. Only after learning these languages, here are some basic starter resources for applied machine learning:
