...
# Getting started
[Python](https://www.python.org/) and [R](https://www.r-project.org/) are must-know programming languages for practicing modern machine learning. If using Python, version 3 strongly preferred over the legacy version 2. Only after you learn these, here are some basic starter resources for machine learning:
